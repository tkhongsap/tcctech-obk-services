  ...
  return (
    <>
      ...
      <View
        ...
        <Text weight="medium">{t('General__Vehicle_type', 'Vehicle type')}</Text>
      ...
      <View
        ...
        <Text weight="medium">{t('General__Totle_payment_amount', 'Total')}</Text>
        <Text size="H3" weight="medium">{`${t('General__Bath_fee', '{{totalFee}} Bath', {
