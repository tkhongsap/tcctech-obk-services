...
import notificationAction from '~/states/notification/notificationAction';
  ...
  useEffect(() => {
    if (authenState.token.value) {
      ...
      const loadNotification = async () => {
        await notificationAction.fetchNotifcation();
      };
      getMemberIdAndTower();
    ...
    <Screen>
      ...
      <ScrollView
        ...
        <Pressable className={getTheme('bg-default')}>
          ...
          <ParkingAvailability parkingLot={parkingLotValue} />
          <AnouncementSection
            message={message}
            showSection={
