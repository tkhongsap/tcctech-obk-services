...
public class CreateMaintainanceRepairResult
{
	public CreateMaintainanceRepairResultData? data { get; set; }
}
public class CreateMaintainanceRepairResultData
{
	...
	public CreateMaintainanceRepairImage? image { get; set; }
}

public class CreateMaintainanceRepairImage
{
	public string? id { get; set; }
