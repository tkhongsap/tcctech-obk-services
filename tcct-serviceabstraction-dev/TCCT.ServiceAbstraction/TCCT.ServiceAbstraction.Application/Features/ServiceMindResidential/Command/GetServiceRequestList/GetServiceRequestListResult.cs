...
public class GetServiceRequestListResult
{
    ...
    public List<GetServiceRequestListResultData>? data { get; set; }
}

public class GetServiceRequestListResultData
{
    ...
    public List<GetServiceRequestListResultData.ReportedByFloors>? reportedByFloors { get; set; }
