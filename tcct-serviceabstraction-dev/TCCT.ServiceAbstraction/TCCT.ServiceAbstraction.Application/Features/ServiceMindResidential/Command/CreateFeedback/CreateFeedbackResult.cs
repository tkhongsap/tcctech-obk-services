...
{
	public CreateFeedbackResultData? data { get; set; }
}
public class CreateFeedbackResultData
{
	...
	public CreateFeedbackImage? image { get; set; }
}

public class CreateFeedbackImage
{
	public string? id { get; set; }
