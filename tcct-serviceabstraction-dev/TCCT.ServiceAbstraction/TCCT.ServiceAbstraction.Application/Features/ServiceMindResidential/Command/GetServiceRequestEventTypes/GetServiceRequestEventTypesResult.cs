...
public class GetServiceRequestEventTypesResult
{
    ...
    public List<GetServiceRequestEventTypesResultData>? data { get; set; }
}


public class GetServiceRequestEventTypesResultData
{
