...
public class GetMaintainanceRepairListResult
{
    ...
    public List<GetMaintainanceRepairListResultData>? data { get; set; }
}

public class GetMaintainanceRepairListResultData
{
    ...
    public List<ReportedByFloors>? floors { get; set; }
    public List<ReportedByFloors>? commonAreaFloors { get; set; }
    ...
    public List<ReportedByFloors>? reportedByFloors { get; set; }
