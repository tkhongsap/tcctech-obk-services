...
public class UpdateResidenceMemberCommand : ICommand<UpdateResidenceMemberResult>
{
	...
	public UpdateResidenceMemberCommand(string personID, string? firstname, string? lastname, string? gender, string? idcard, string? passport, string? phone, string? email, string? note, string? cardNumber, string? startDate, string? endDate, List<int> serviceType, List<int>? residentIDList, List<EmailList>? emailList, List<PhoneList>? phoneList, List<ImageList>? imageList, bool? active, List<CardResidenceList>? cardResidenceList, bool? canPreRegister = true)
	{
		PersonID = personID;
		Firstname = firstname;
		Lastname = lastname;
