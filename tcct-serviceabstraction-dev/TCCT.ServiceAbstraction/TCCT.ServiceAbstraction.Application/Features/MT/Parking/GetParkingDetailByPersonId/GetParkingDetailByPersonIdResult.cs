...
namespace TCCT.ServiceAbstraction.Application.Features.MT.Parking.GetParkingDetailByPersonId;
    public class GetParkingDetailByPersonIdResult
	{
		public int? status { get; set; } = null!;
		public string? message { get; set; }
		public List<GetParkingDetailByPersonIdDataResult>? data { get; set; }
        public int? count { get; set; }
	} 

    public class GetParkingDetailByPersonIdDataResult
    {
