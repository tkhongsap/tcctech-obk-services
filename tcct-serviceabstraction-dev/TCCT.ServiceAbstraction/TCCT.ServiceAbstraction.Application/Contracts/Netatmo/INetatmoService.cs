...
public interface INetatmoService
{
	...
	/// <summary>
	/// Create <b>Heating Schedule</b>
	/// </summary>
	Task<CreateNewHomeScheduleResult> CreateNewHomeSchedule(string homeId, string name, float awayTemp, float hgTemp, List<TimeTableType> timetable, List<ZoneType> zones, string? tenantId); // Create Heating Schedule
																																																																																					// Create New Home Schedule 
	/// <summary>
	/// Create <b>Heating Event</b> schedule
	/// </summary>
	Task<CreateNewHomeScheduleResult> CreateNewHomeSchedule(string homeId, string name, string scheduleType, List<TimeTableType> timetable, List<ZoneType> zones, string? tenantId); // Create event heating
	/// <summary>
	/// Create <b>Cooling</b> schedule
	/// </summary>
	Task<CreateNewHomeScheduleResult> CreateNewHomeSchedule(string homeId, string name, float coolingAwayTemp, string scheduleType, bool selected, List<TimeTableType> timetable, List<ZoneType> zones, string? tenantId); // Create Cooling Schedule
	/// <summary>
	/// Create <b>Action</b> schedule
	/// </summary>
	Task<CreateNewHomeScheduleResult> CreateNewHomeSchedule(string homeId, string name, string scheduleType, List<TimeTableType> timetable, List<ZoneType> zones, List<TimetableSunType> timeTableSunrise, List<TimetableSunType> timeTableSunset, string? tenantId); // Create Action Schedule
