...
const EditExplore = ({ initialData }: { initialData: any }) => {
...
export const getServerSideProps = withGenericServer(
  async (ctx: any) => {
    ...
    if (id && typeof id === 'string') {
      initialData = await exploreService
        .get(id)
        .then((res) => res.data)
        .catch((err) => {
          console.log('Fetch explore detail error: ', err)
