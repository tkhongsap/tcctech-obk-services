...
const PreviewContentTable = (props: any) => {
  const { content } = props
  ...
  return (
    <div className='flex flex-column gap-1 w-full'>
      <div className='flex w-full tw-justify-between align-items-center px-3 mb-2'>
        <ArrowBackIcon />
        <h6 className='text-astronaut font-bold mb-0 mt-0'>{content.menu}</h6>
        <div></div>
      </div>
      <div
...
export default PreviewContentTable
