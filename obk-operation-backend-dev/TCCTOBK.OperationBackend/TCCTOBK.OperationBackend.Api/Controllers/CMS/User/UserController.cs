...
[ApiController]
[Route("api/v1/operation/user")]
[ApiExplorerSettings(GroupName = "cmsv1")]
public class UserCMSController : OperationApiControllerBase
{
  private readonly IMediator _mediator;
  private readonly IAuditableService _auditableService;

  public UserCMSController(IMediator mediator, IAuditableService auditableService)
  {
    _mediator = mediator;
