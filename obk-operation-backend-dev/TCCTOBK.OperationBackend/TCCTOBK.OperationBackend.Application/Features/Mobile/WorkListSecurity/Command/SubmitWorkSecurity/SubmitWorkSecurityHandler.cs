...
public class SubmitWorkSecurityHandler : IRequestHandler<SubmitWorkSecurityCommand, SubmitWorkSecurityResult>
{
  private readonly IAbstractionService _apiService;
  public SubmitWorkSecurityHandler(IAbstractionService apiService)
  {
    _apiService = apiService;
  }
  public async Task<SubmitWorkSecurityResult> Handle(SubmitWorkSecurityCommand request, CancellationToken cancellationToken)
  {
    ...
    return new SubmitWorkSecurityResult() { WorkId = request.WorkId, Status = "Submit" };
  }
}
