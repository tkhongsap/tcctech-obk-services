namespace TCCTOBK.OperationBackend.Application.Features;

public class RejectCWOResultResponse
{
  ...
  public List<cwoComments> cwoComments { get; set; } = new();
  public List<cwoTransactions> cwoTransactions { get; set; } = new();
}
