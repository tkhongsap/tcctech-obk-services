...
public class AcknowledgeWorkHandler : IRequestHandler<AcknowledgeWorkCommand, AcknowledgeWorkResult>
{
  private readonly IAbstractionService _apiService;
  public AcknowledgeWorkHandler(IAbstractionService apiService)
  {
    _apiService = apiService;
  }

  public async Task<AcknowledgeWorkResult> Handle(AcknowledgeWorkCommand request, CancellationToken cancellationToken)
  {
    ...
    return new AcknowledgeWorkResult() { WorkId = request.WorkId };
  }
}
