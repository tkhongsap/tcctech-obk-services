...
namespace TCCTOBK.OperationBackend.Infrastructure.Database.Migrations
{
    ...
    [Migration("20240626082800_UpdateStatusSubtaskAndReferenceKeyTrAction")]
    partial class UpdateStatusSubtaskAndReferenceKeyTrAction
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TCCTOBK.OperationBackend.Domain.Entities.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 6, 26, 15, 27, 59, 358, DateTimeKind.Local).AddTicks(234),
                            IsActive = true,
                            Name = "OBK CMS",
                            UpdatedBy = "00000000-0000-0000-0000-000000000000",
                            UpdatedByName = "System",
                            UpdatedDate = new DateTime(2024, 6, 26, 15, 27, 59, 358, DateTimeKind.Local).AddTicks(5032),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "00000000-0000-0000-0000-000000000000",
                            CreatedByName = "System",
                            CreatedDate = new DateTime(2024, 6, 26, 15, 27, 59, 358, DateTimeKind.Local).AddTicks(5537),
                            IsActive = true,
                            Name = "Operation app",
                            UpdatedBy = "00000000-0000-0000-0000-000000000000",
                            UpdatedByName = "System",
                            UpdatedDate = new DateTime(2024, 6, 26, 15, 27, 59, 358, DateTimeKind.Local).AddTicks(5540),
            ...
            modelBuilder.Entity("TCCTOBK.OperationBackend.Domain.Entities.trSubtaskAction", b =>
                {
                    b.HasOne("TCCTOBK.OperationBackend.Domain.Entities.trAction", "trAction")
                        .WithOne("trSubtaskAction")
                        .HasForeignKey("TCCTOBK.OperationBackend.Domain.Entities.trSubtaskAction", "Action")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
