...
namespace TCCTOBK.OperationBackend.Infrastructure.Database.Migrations
{
    ...
    [Migration("20250122004456_RenameStaffIdMember")]
    partial class RenameStaffIdMember
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TCCTOBK.OperationBackend.Domain.Entities.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 1, 22, 7, 44, 56, 416, DateTimeKind.Local).AddTicks(3500),
                            IsActive = true,
                            Name = "OBK CMS",
                            UpdatedBy = "00000000-0000-0000-0000-000000000000",
                            UpdatedByName = "System",
                            UpdatedDate = new DateTime(2025, 1, 22, 7, 44, 56, 439, DateTimeKind.Local).AddTicks(8750),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "00000000-0000-0000-0000-000000000000",
                            CreatedByName = "System",
                            CreatedDate = new DateTime(2025, 1, 22, 7, 44, 56, 439, DateTimeKind.Local).AddTicks(8980),
                            IsActive = true,
                            Name = "Operation app",
                            UpdatedBy = "00000000-0000-0000-0000-000000000000",
                            UpdatedByName = "System",
                            UpdatedDate = new DateTime(2025, 1, 22, 7, 44, 56, 439, DateTimeKind.Local).AddTicks(8990),
            ...
            modelBuilder.Entity("TCCTOBK.OperationBackend.Domain.Entities.trRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "00000000-0000-0000-0000-000000000000",
                            CreatedByName = "System",
                            CreatedDate = new DateTime(2025, 1, 22, 7, 44, 56, 440, DateTimeKind.Local).AddTicks(9510),
                            ...
                            UpdatedBy = "00000000-0000-0000-0000-000000000000",
                            UpdatedByName = "System",
                            UpdatedDate = new DateTime(2025, 1, 22, 7, 44, 56, 440, DateTimeKind.Local).AddTicks(9510)
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            UpdatedBy = "00000000-0000-0000-0000-000000000000",
                            UpdatedByName = "System",
                            UpdatedDate = new DateTime(2025, 1, 22, 7, 44, 56, 440, DateTimeKind.Local).AddTicks(9520)
                        },
                        new
                        {
                            ...
                            CreatedBy = "00000000-0000-0000-0000-000000000000",
                            CreatedByName = "System",
                            CreatedDate = new DateTime(2025, 1, 22, 7, 44, 56, 440, DateTimeKind.Local).AddTicks(9520),
                            Description = "Dcc",
                            IsActive = true,
                            IsDelete = false,
                            Name = "Dcc",
