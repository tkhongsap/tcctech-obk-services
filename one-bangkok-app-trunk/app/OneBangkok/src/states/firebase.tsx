...
const featureSwitch = {
  ...
  enable_bookmark_wmm_dgl_content: false,
  ...
  enable_residential_bill_payment: false,
  enable_residential_questionnaire: false,
  enable_walking_map_interactive: false,
...
const parking_redemption_file_max_size = 10;
...
const firebaseConfigState = hookstate({
  ...
  delay_get_resident_home_automation: 1000,
  call_lift_queue_interval_time_ms: 3000,
  ...
  parking_redemption_file_max_size: parking_redemption_file_max_size,
});
