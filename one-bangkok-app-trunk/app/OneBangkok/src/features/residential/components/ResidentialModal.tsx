...
type ModalState = {
  ...
  onBackdropPress: {func: () => void; enabled: boolean};
...
const defaultModalState: ModalState = {
  ...
  onBackdropPress: {func: () => {}, enabled: false},
...
export const modalActions = {
  ...
  setOnBackdropPress: (onBackdropPress: {
    func: () => void;
    enabled: boolean;
  }) => {
  ...
  setStates: ({
    ...
    animationInTiming = undefined,
    animationOutTiming = undefined,
  }: Partial<Omit<ModalState, 'isVisible' | 'children'>>) => {
