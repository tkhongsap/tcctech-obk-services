...
const SignUpConfirmPasswordScreen = ({
  ...
  const languageState = useHookstate(appLanguageState);
  const currentLanguage =
    languageState.currentLanguage.get() !== ''
      ? languageState.currentLanguage.get()
      : languageState.defaultLanguage.get();
  ...
  return (
    <Screen>
      ...
      <ScrollView
        ...
        <HeadText
          titleClamps={
            currentLanguage === 'th' ? 'leading-normal' : 'leading-[35.2px]'
          }
          tagline={header}
          title={title}
          titleSize="H2"
