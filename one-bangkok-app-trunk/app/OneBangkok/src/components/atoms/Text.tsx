...
export const textWeightVariantTextEditor = {
  regular: getTheme('OneBangkok-Regular'),
  medium: getTheme('OneBangkok-Medium'),
  bold: getTheme('OneBangkok-Bold'),
};
...
export const textColorVariant = {
  ...
  navy: getTheme('text-navy'),
  'soft-white': getTheme('text-soft-white'),
  'greyscale-400': getTheme('text-greyscale-400'),
  white: getTheme('text-white'),
  'muted-500': getTheme('text-muted-500'),
  black: getTheme('text-black'),
};
