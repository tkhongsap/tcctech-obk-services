...
export const OBError = {
   ...
   */
  BUS_INT_001: { errorCode: 'BUS_INT_001', status: 400, message: 'Type mismatch' },
  /**
   * status: 500, message: 'Cannot find data on google map distance api'
   */
  BUS_GOG_001: { errorCode: 'BUS_GOG_001', status: 500, message: 'Cannot find data on google map distance api' },
  /**
   * status: 500, message: 'Bus is not in calculated area'
   */
  BUS_ARE_001: { errorCode: 'BUS_ARE_001', status: 500, message: 'Bus is not in calculated area' },
  /**
   * status: 500, message: 'Bus cannot find the destination'
   */
  BUS_DES_001: { errorCode: 'BUS_DES_001', status: 500, message: 'Bus cannot find the destination' },
};
